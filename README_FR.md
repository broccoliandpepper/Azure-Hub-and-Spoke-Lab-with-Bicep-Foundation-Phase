...
> Ce lab a été conçu comme un support d'apprentissage pour découvrir et pratiquer Bicep à travers la construction d'une architecture réseau Azure de type Hub-and-Spoke. Il s'adresse aux architectes auto-didacte, ingénieurs cloud et étudiants curieux souhaitant acquérir des bases solides sur l'infrastructure as code avec Bicep, en partant d'une fondation modulaire, évolutive et pédagogique.
